			...
			<div class="content">
				<form class="form-horizontal">
					<div class="form-group">
						...
						<label for="oldPassword" class="col-xs-2 control-label">原密码</label>
						<div class="col-xs-5">
					...
					<div class="form-group">
						<div class="col-xs-2 "></div>
						<label for="Password2" class="col-xs-2 control-label">再次密码</label>
						<div class="col-xs-5">
	...
	<script>
		...
		function oldpwdCheck(thisinput) {
			...
			if(!isnotEmpty($(thisinput).val())) {
				...
				$.ajax({
					url: '<%=basePath%>backgroundManagement/background/userManager/decidePwd',
					type: "POST",
					dataType: "json",
					async: false,
					cache: false,
			...
			if(oldpwdCheck("#oldPassword")){
				if(userpwdCheck("#Password")){
					if(aginpwdCheck("#Password2")){
						$.ajax({
							url: '<%=basePath%>backgroundManagement/background/userManager/updatePwd',
							type: "POST",
							dataType: "json",
							async: false,
							cache: false,
